...
--
-- Host: localhost
-- Generation Time: Apr 21, 2017 at 05:32 PM
...
CREATE TABLE IF NOT EXISTS `Employees` (
  ...
  `Fname` varchar(25) CHARACTER SET utf8 NOT NULL,
  `Lname` varchar(25) CHARACTER SET utf8 NOT NULL,
  `Account_type` int(5) NOT NULL DEFAULT '1',
...
INSERT INTO `Employees` (`EmployeeID`, `Fname`, `Lname`, `Account_type`, `username`, `password`, `hours`) VALUES
(1, 'Darren', 'Snyder', 0, 'dsnyder', 'password', 3.4);
